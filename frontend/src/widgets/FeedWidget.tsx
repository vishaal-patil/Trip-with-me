    ...
    return (
        <div className="w-full h-full p-4 md:p-6 pb-24 md:pb-6 overflow-y-auto">
            ...
            <div className="grid gap-6 max-w-2xl mx-auto">
                {FEED_ITEMS.map((item) => (
                    <GlassCard key={item.id} className="group overflow-hidden p-0 border-white/5 bg-black/40 hover:bg-black/60">
                        {/* Image Section */}
                        ...
                        <div className="p-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-sm font-medium text-white block">{item.user}</span>
                ...
                <GlassCard className="p-8 text-center text-gray-500 border-dashed border-white/10 hover:border-white/20 cursor-pointer">
